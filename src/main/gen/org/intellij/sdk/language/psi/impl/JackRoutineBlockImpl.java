...
public class JackRoutineBlockImpl extends ASTWrapperPsiElement implements JackRoutineBlock {

  public JackRoutineBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JackVisitor visitor) {
    visitor.visitRoutineBlock(this);
  }

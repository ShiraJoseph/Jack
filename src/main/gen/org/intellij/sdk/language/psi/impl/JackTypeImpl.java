...
public class JackTypeImpl extends ASTWrapperPsiElement implements JackType {

  public JackTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public JackPrimitiveType getPrimitiveType() {
    return findChildByClass(JackPrimitiveType.class);
  }

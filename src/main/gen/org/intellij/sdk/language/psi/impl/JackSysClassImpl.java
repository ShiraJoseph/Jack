...
public class JackSysClassImpl extends ASTWrapperPsiElement implements JackSysClass {

  public JackSysClassImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JackVisitor visitor) {
    visitor.visitSysClass(this);
  }

...
public class JackAssignmentOperatorImpl extends ASTWrapperPsiElement implements JackAssignmentOperator {

  public JackAssignmentOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

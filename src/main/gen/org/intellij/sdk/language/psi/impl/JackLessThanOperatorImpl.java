...
public class JackLessThanOperatorImpl extends ASTWrapperPsiElement implements JackLessThanOperator {

  public JackLessThanOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

...
public class JackIfKeywordImpl extends ASTWrapperPsiElement implements JackIfKeyword {

  public JackIfKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JackVisitor visitor) {
    visitor.visitIfKeyword(this);
  }

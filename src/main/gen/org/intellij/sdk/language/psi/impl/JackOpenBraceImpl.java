...
public class JackOpenBraceImpl extends ASTWrapperPsiElement implements JackOpenBrace {

  public JackOpenBraceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JackVisitor visitor) {
    visitor.visitOpenBrace(this);
  }

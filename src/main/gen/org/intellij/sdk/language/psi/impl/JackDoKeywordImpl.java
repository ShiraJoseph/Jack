...
public class JackDoKeywordImpl extends ASTWrapperPsiElement implements JackDoKeyword {

  public JackDoKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull JackVisitor visitor) {
    visitor.visitDoKeyword(this);
  }
